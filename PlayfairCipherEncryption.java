...

{
	...
	static private String KeyWord="helloworld";
  ...
  String src_arr[] = Divid2Pairs(Source);
        ...
        {
            alpha1 = src_arr[i].charAt(0);
            alpha2 = src_arr[i].charAt(1);
            part1 = GetDiminsions(alpha1);
            part2 = GetDiminsions(alpha2);
            if (part1[0] == part2[0])
            {
                if (part1[1] < 4)
                    part1[1]++;
            ...
            Code = Code + keymatrix[part1[0]][part1[1]] + keymatrix[part2[0]][part2[1]];
        }
        return Code;
    }        
    ...
    public static void main(String args[])
    {
       PlayfairCipherEncryption x = new PlayfairCipherEncryption();
        ...
        System.out.println("Keyword for a message : " + KeyWord);
        x.setKey(KeyWord);
        x.KeyGen();
